...
module.exports.run = async (bot, message, args) => {
  const member = message.mentions.members.first() || message.guild.members.cache.get(args[0]) || message.member;
    ...
    if (!item) {
              ...
              .setColor("#eda098")
              .setTitle('> hmmmm.... <a:wheart:801471261066002432> <:girlhmmthink:804652502951395368>')
              .setDescription(`You dont have this item! Make sure you have typed the correct \`id\`.`);
    ...
    if (!item.canUse) {
              ...
              .setColor("#eda098")
              .setTitle('> hmmmm.... <a:wheart:801471261066002432> <:girlhmmthink:804652502951395368>')
              .setDescription(`You can't use this item.`);
    ...
    if (!founditem) {
              ...
              .setColor("#eda098")
              .setTitle('> hmmmm.... <a:wheart:801471261066002432> <:girlhmmthink:804652502951395368>')
              .setDescription(`You don't have this item! Make sure you have typed the correct \`id\`.`);
              return message.channel.send(use3embed);
